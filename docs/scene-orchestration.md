...
| `src/components/scene/MusicalSceneContent.tsx` | Scene graph composition (lights, environment, controls) | `perfLevel`, `starCountScale`, `postprocessingEnabled` | Stable interactive scene subtree |
